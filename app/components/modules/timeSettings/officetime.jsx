...
class OfficeTime extends Component {
    ...
    _add = () => {
        browserHistory.push('/system-settings/officetime/add')
    }
    _clearSelectRows = () => {
        this.setState({
            selectedRowKeys: [],
    ...
    _edit = (record, index) => {
        browserHistory.push('/system-settings/officetime/edit/' + record.condition_index + '/' + record.index)
    }
    _getInitData = () => {
        const { formatMessage } = this.props.intl
    ...
    render() {
        ...
        const columns = [{
                ...
                sorter: (a, b) => a.condition_index.length - b.condition_index.length
            }, {
                key: 'sequence',
                dataIndex: 'sequence',
                className: 'hidden',
                ...
                render: (text, record, index) => {
                    return <div><span>{ record.index }</span></div>
                }
            }, {
                key: 'time',
                dataIndex: 'time',
                ...
                sorter: (a, b) => a.week_day.length - b.week_day.length,
                render: (text, record, index) => {
