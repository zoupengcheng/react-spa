                    ...
                    <Form>
                        ...
                        <FormItem
                            ...
                            { getFieldDecorator('login_status', {
                                ...
                                <span style={crmSettings.login_status === "logout" ? { color: 'grey' } : { color: 'green' }}>{ crmSettings.login_status === "logout" ? formatMessage({id: "LANG5187"}) : formatMessage({id: "LANG5186"}) }</span>
                            ) }
                        </FormItem>
                    </Form>
                </div>
