    ...
    _createStatus = (text, record, index) => {
        ...
        if (disabled === 'yes') {
            ...
            if (statusLower === 'unavailable' || statusLower === 'unvailable') {
                // unavailable
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG113" })} ></span>
                ...
                // unreachable
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2394" })} ></span>
                ...
                // lagged
                status = <span color="gray" className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2397" })} ></span>
                ...
                // unregistered
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2399" })} ></span>
            } else if (statusLower === 'failed') {
                // failed
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2405" })} ></span>
            } else if (statusLower === 'unknown') {
                // unknown
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2403" })} ></span>
            } else if (statusLower === 'rejected') {
                // rejected
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2401" })} ></span>
            } else if (statusLower === 'timeout') {
                // timeout
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG102" })} ></span>
            } else if (statusLower.contains('no authentication') || statusLower === 'no') {
                // no authentication
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2428" })} ></span>
            } else if (statusLower.contains('auth. sent') || statusLower.contains('request sent') || statusLower === 'request') {
                // trying
                status = <span className="sprite sprite-busy" title={formatMessage({ id: "LANG2402" })} ></span>
            } else if (statusLower === 'errorconfigured') {
                // Error configured
                status = <span className="sprite sprite-unmonitored" title={formatMessage({ id: "LANG2795" })} ></span>
            }
        }
            ...
            <div className="trunks">
                <Card title="Trunks" bordered={true} bodyStyle={{ padding: 0 }}>
                    <div className="trunks-total">
                        <Row gutter={10}>
                            <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 12}} md={{ span: 12}} lg={{ span: 9}}>
                                <Row gutter={10}>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 12}} md={{ span: 12}} lg={{ span: 12}}>
                                        <div id="trunksPercent" style={{width: 52, height: 52}}></div>
                                    </Col>
                                    <Col className="gutter-row text-center" pull={2} xs={{ span: 24}} sm={{ span: 12}} md={{ span: 9}} lg={{ span: 9}}>
                                        <div>
                            ...
                            <Col className="gutter-row trunks-status" xs={{ span: 24}} sm={{ span: 12}} md={{ span: 12}} lg={{ span: 15}}>
                                <Row gutter={10}>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 9}}>
                                        <span title={formatMessage({id: "LANG110"})} className="sprite sprite-status-available"></span>
                                        <span>{this._checkTextLen(formatMessage({id: "LANG110"}))}</span>
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 3}}>
                                        {this._renderTrunksNumber(trunksData, "available_trunk_number")}
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 9}}>
                                        <span title={formatMessage({id: "LANG2237"})} className="sprite sprite-status-busy"></span>
                                        <span>{this._checkTextLen(formatMessage({id: "LANG2237"}))}</span>
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 3}}>
                                        {this._renderTrunksNumber(trunksData, "busy_trunk_number")}
                                    </Col>
                                </Row>
                                <Row gutter={10}>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 9}}>
                                        <span title="Abnormal" title={formatMessage({id: "LANG5396"})} className="sprite sprite-status-abnormal"></span>
                                        <span>{this._checkTextLen(formatMessage({id: "LANG5396"}))}</span>
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 3}}>
                                        {this._renderTrunksNumber(trunksData, "unavailable_trunk_number")}
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 9}}>
                                        <span title={formatMessage({id: "LANG2395"})} className="sprite sprite-status-unmonitored"></span>
                                        <span>{this._checkTextLen(formatMessage({id: "LANG2395"}))}</span>
                                    </Col>
                                    <Col className="gutter-row" xs={{ span: 24}} sm={{ span: 6}} md={{ span: 6}} lg={{ span: 3}}>
                                        {this._renderTrunksNumber(trunksData, "unmonitored_trunk_number")}
                                    </Col>
                                </Row>
                            </Col>
                        </Row>
