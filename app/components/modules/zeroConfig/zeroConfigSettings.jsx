    ...
    render() {
        ...
        return (
            <div className="app-content-main" id="app-content-main">
                ...
                />
                <Form>
                    <div className="section-title">{formatMessage({id: "LANG2217"})}
                        <FormItem
                            ref="div_enablezc"
                            { ...formItemLayout }
                    ...
                    <div className="section-title">{formatMessage({id: "LANG3905"})}
                        <div className="lite-desc">
                            { formatMessage({id: "LANG1304"}) }
                        </div>
                        <FormItem
                    ...
                    <div className="section-title">{formatMessage({id: "LANG48"})}
                        <FormItem
                            ref="div_subnetTable"
                            { ...formItemLayout }
