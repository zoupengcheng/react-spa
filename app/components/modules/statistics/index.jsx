...
import { Checkbox, Col, Form, Input, InputNumber, message, Row, Tooltip, Upload, Icon, Radio, Select, DatePicker, Button } from 'antd'
            ...
            <div className="app-content-main">
                ...
                <div className="content">
                    <Form>
                        ...
                        <FormItem className={ this.state.monthly }>
                            { getFieldDecorator('monthly-date', {
                                initialValue: currentYear.toString()
                            })(
                                <Select style={{ width: 200 }} onChange={ this._changeTime.bind(this, 'month') }>
                                    {
                        ...
                        <FormItem className={ this.state.weekly }>
                            { getFieldDecorator('weekly-date', {
                                initialValue: currentYear.toString()
                            })(
                                <Select style={{ width: 200 }} onChange={ this._changeTime.bind(this, 'week') }>
                                    {
                                        arrayYear.map(function(value, index) {
                                            return <Option value={ value } key={ index }>{ value }</Option>
                                        })
