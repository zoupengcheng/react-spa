...
class MusicOnHoldList extends Component {
    ...
    _batchDelete = () => {
        ...
        if ((this.state.selectedRows.length === this.props.mohList) && (this.props.mohClass.toLowerCase() === "")) {
    ...
    render() {
        ...
        const props = {
            name: 'file',
            action: host + 'action=uploadfile&type=moh&data=' + this.props.mohClass,
            headers: {
